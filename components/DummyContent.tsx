        ...
        <div className="flex justify-between px-4 mx-auto max-w-4xl ">
          <article className="w-full text-gray-600 space-y-6">
            ...
            <ol className="space-y-1.5">
              <li>
                <strong className="text-gray-100">Usability testing:</strong> Does your user know how to
              ...
              <li>
                <strong className="text-gray-100">Involving stakeholders:</strong> Need to check if your
              ...
              <li>
                <strong className="text-gray-100">Impressing a client:</strong> Prototypes can help explain
                or even sell your idea by providing your client with a hands-on
                experience.
                Prototypes can help explain
                or even sell your idea by providing your client with a hands-on
                experience.
                Prototypes can help explain
                or even sell your idea by providing your client with a hands-on
              ...
              <li>
                <strong className="text-gray-100">Communicating your vision:</strong> By using an
